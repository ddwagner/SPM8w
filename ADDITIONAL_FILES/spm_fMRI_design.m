...
for s = 1:length(SPM.nscan)
    ...
    if (s == 1) || ~rep
        ...
        %------------------------------------------------------------------
%===DDW EDIT====================================================================
        %===Enable/Disable fix_orth depending on p.fix_orth in parameters.
        global disable_orth
        if disable_orth == 0
            for i = 1:length(Fc)
            ...
            fprintf(['NB: Within-condition orthogonalization of regressors is disabled.\n' ...
                     'This will impact designs with multiple regressors per condition such as \n' ...
                     'FIR, Parametric analyses, and designs with additional basis functions. See:\n'...
                     'http://www.jiscmail.ac.uk/cgi-bin/wa.exe?A2=SPM;Amep9Q;20090504153640-0500\n\n']);
        end
%===DDW EDIT====================================================================

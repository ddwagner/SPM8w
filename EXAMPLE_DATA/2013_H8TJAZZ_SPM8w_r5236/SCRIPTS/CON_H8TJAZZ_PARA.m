...
% ==============================================================================
% Contrast order: [Human, HumanPara1, HumanPara2, Animal, Vegetable, Mineral]

con_vals{1}         = [1 0 0 1 1 1 zeros(1,len)];
con_name{1}         = 'allVSbas';

con_vals{2}         = [1 0 0 0 0 0 zeros(1,len)];
con_name{2}         = 'humVSbas';

con_vals{3}         = [0 0 0 1 0 0 zeros(1,len)];
con_name{3}         = 'aniVSbas';

con_vals{4}         = [0 0 0 0 1 0 zeros(1,len)];
con_name{4}         = 'vegVSbas';

con_vals{5}         = [0 0 0 0 0 1 zeros(1,len)];
con_name{5}         = 'minVSbas';

con_vals{6}         = [0 1 0 0 0 0 zeros(1,len)];
con_name{6}         = 'humanPara1';

con_vals{7}         = [0 0 1 0 0 0 zeros(1,len)];
con_name{7}         = 'humanPara2';

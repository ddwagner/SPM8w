...
glm_dir   = 'GLM_H8TJAZZ_MIXED';                                                      
rfx_dir   = 'RFX_H8TJAZZ_MIXED';
confile   = 'CON_H8TJAZZ_MIXED.m'; %Name of the confile for this study <optional>

%---ONSETS SPECIFICATIONS
onsets_dirname    = 'H8TJAZZ_MIXED';
...
p.event_cond = {'human';'animal';'oncue';'offcue'};
p.block_cond = {'implicit';'explicit'};
p.reg_cond   = {};
...
p.coreg2epi     = 0;        %Coregister Anat to EPI data (mean of session 1)?
...
p.hrf          = 'Finite Impulse Response';  %Set to Finite Impulse Response for MIXED designs.

function ds = spm8w_uw_estimate(P,par)
...
old_P = P;
if ds.fwhm ~= 0
   fprintf('Creating a smoothed time series for estimation:   ');    %===DDW EDIT===
   %spm_uw_show('SmoothStart',length(P));                            %===DDW EDIT===
   temp_dir=fullfile(pwd,'temp');                                    %===DDW EDIT===
   system(spm8w_osbabel(sprintf('mkdir "%s"',temp_dir)));            %===DDW EDIT===
   for i=1:length(old_P)
      %spm_uw_show('SmoothUpdate',i);                                %===DDW EDIT===
      fprintf([repmat('\b',1,3),'%3.0f'],i);                         %===DDW EDIT===
      %sfname(i,:) = [tempname '.img,1,1'];                          %===DDW EDIT===
      sfname(i,:) = sprintf('%s',[temp_dir,'/',spm8w_tempname '.img,1,1']);%===DDW EDIT===
      to_smooth = sprintf('%s,%d,%d',old_P(i).fname,old_P(i).n);
      spm_smooth(to_smooth,sfname(i,:),ds.fwhm);
   end
   P = spm_vol(sfname);
   %spm_uw_show('SmoothEnd');                                        %===DDW EDIT===
end
...
%
fprintf('\nPerforming iterative search for deformation fields: ');              %===DDW EDIT===
for iter=1:ds.noi
   %spm_uw_show('NewIter',iter);                                                %===DDW EDIT===
   fprintf([repmat('\b',1,1),'%1.0f'],iter);                                    %===DDW EDIT===
   ...
   if iter > 1 && yty > ssq(iter-1)
      ...
      %spm_uw_show('StartInv',1);                                   %===DDW EDIT===
      ...
      %spm_uw_show('EndInv');                                                %===DDW EDIT===
      tmp = dispP.mat;
      dispP.mat = P(1).mat;
      %spm_uw_show('FinIter',ssq,def,ds.fot,ds.sot,dispP,ds.q);              %===DDW EDIT===
      dispP.mat = tmp;
   end
   clear AtA
end
...
system(spm8w_osbabel(sprintf('rm -r "%s"',temp_dir)));                      %===DDW EDIT===
return
...
if ds.jm, %spm_uw_show('StartAtA',10);                   %===DDW EDIT===
else %spm_uw_show('StartAtA',6);                         %===DDW EDIT=== 
end                                                      %===DDW EDIT===

nof   = prod(size(ds.fot)) + size(ds.sot,1);

AxtAx = uwAtA1(dx.*dx,Bx,By,Bz); %spm_uw_show('NewAtA',1); %===DDW EDIT===
AytAy = uwAtA1(dy.*dy,Bx,By,Bz); %spm_uw_show('NewAtA',2); %===DDW EDIT===
AztAz = uwAtA1(dz.*dz,Bx,By,Bz); %spm_uw_show('NewAtA',3); %===DDW EDIT===
AxtAy = uwAtA1(dx.*dy,Bx,By,Bz); %spm_uw_show('NewAtA',4); %===DDW EDIT===
AxtAz = uwAtA1(dx.*dz,Bx,By,Bz); %spm_uw_show('NewAtA',5); %===DDW EDIT===
AytAz = uwAtA1(dy.*dz,Bx,By,Bz); %spm_uw_show('NewAtA',6); %===DDW EDIT===

if ds.jm
   AjtAj = uwAtA1(ref.*ref,Bx,dBy,Bz); %spm_uw_show('NewAtA',7);            %===DDW EDIT===
   AxtAj = uwAtA2( dx.*ref,Bx, By,Bz,Bx,dBy,Bz); %spm_uw_show('NewAtA',8);  %===DDW EDIT===
   AytAj = uwAtA2( dy.*ref,Bx, By,Bz,Bx,dBy,Bz); %spm_uw_show('NewAtA',9);  %===DDW EDIT===
   AztAj = uwAtA2( dz.*ref,Bx, By,Bz,Bx,dBy,Bz); %spm_uw_show('NewAtA',10); %===DDW EDIT===
end
...
%spm_uw_show('StartAty',length(P));              %===DDW EDIT===
for scan = 1:length(P)
   %spm_uw_show('NewAty',scan);                  %===DDW EDIT===
   T    = P(scan).mat\ds.M;
   txyz = xyz*T(1:3,:)';
...
%
%spm_uw_show('StartRef',length(P));             %===DDW EDIT===
...
%
%spm_uw_show('StartRefit',1);               %===DDW EDIT===
rsP     = P(1);
...
%
%spm_uw_show('MaskStart',length(P));                 %===DDW EDIT===
...
for i=1:length(P)
   ...
   msk  = msk & tmsk;
  % spm_uw_show('MaskUpdate',i);                     %===DDW EDIT===
end
%
